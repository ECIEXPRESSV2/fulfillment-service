...
export class EnvironmentVariables {
  ...
  // Cuenta de storage donde vive el contenedor privado compartido `orders` (QRs de fulfillment
  // en `<orderId>/qr/...`, evidencia de reembolsos de orders-service en `<orderId>/refunds/...`).
  // Si está vacía, el QR se sirve por el endpoint público de fallback (útil en local/dev sin
  ...
  @IsString()
  @IsNotEmpty()
  AZURE_STORAGE_ORDERS_CONTAINER: string = 'orders';
